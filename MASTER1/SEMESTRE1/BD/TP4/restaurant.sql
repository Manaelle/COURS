...
db.comments.insert({"_id":"2","restaurant id":"40386672","name client":"Gui","comment":"Frankement c'est pas si mal","type":"positive"})
db.comments.insert({"_id":"3","restaurant id":"40385587","name client":"Gui","comment":"OK","type":"positive"})
db.comments.insert({"_id":"4","restaurant id":"40385885","name client":"xxbgdu38","comment":"J'ai eu du mal à trouver la bouffe, il s'était caché","type":"negative"})
