...
//  colonne 1 |   colonne 2 |   +2 octets pour atteindre 8 
    0,255,  0 , 255,255,  0 ,     0,0 , 	// ligne 1 
  255,  0,255 , 0  ,  0,255 ,     0,0   // ligne 2 
};


GLubyte image_texture2[] = {
//  colonne 1 |   colonne 2 |   colonne 3 |  +2 octets pour atteindre 8 
      0,255,  0,    0,  0,  0,  255,255,  0,   0, 0, 0, 	// ligne 1 
    255,  0,255,  255,255,255,  255,  0,  0,   0, 0, 0,  // ligne 2 
      0,255,255,  128,128,128,    0,  0,255,   0, 0, 0  // ligne 3 
};
...
void cube()
{
	...
	//EXO 6
	/*GLdouble tx1 = 0.0, ty1 = 1.0; // sommet 1  
	GLdouble tx2 = 0.0, ty2 = 1.0; // sommet 2  
	GLdouble tx3 = 0.0, ty3 = 0.0; // sommet 3  
	GLdouble tx4 = 0.0, ty4 = 0.0; // sommet 4 */
	...
	//EXO 7.2
	GLdouble tx1 = 3.0, ty1 = 3.0;
	GLdouble tx2 = 0.0, ty2 = 3.0;
	GLdouble tx3 = 0.0, ty3 = 0.0; 
	GLdouble tx4 = 3.0, ty4 = 0.0;
	...
	for (i=0; i<NB_FACES_CUBE; i++)
	{
		...
		//EXO 7.1
		/*GLdouble tx1 = (1.0/3.0) + tx, ty1 = (1.0/2.0) + ty;  
		GLdouble tx2 = 0.0 + tx, ty2 = (1.0/2.0) + ty; 
		GLdouble tx3 = 0.0 + tx, ty3 = 0.0 + ty;  
		GLdouble tx4 = (1.0/3.0) + tx, ty4 = 0.0 + ty;
		tx = (1.0/3.0) + tx;
		if (i==2){
				tx= 0.0;
				ty= (1.0/2.0);
		...
		switch(i){
				case 0:
						texture_cube = Texture("texture_de_1.ppm"); 
						break;
				case 1:
						texture_cube = Texture("texture_de_2.ppm"); 
						break;
				case 2:
						texture_cube = Texture("texture_de_3.ppm"); 
						break;
				case 3:
						texture_cube = Texture("texture_de_4.ppm"); 
						break;
				case 4:
						texture_cube = Texture("texture_de_5.ppm"); 
						break;
				case 5:
						texture_cube = Texture("texture_de_6.ppm"); 
						break;
		}
		glBindTexture(GL_TEXTURE_2D, texture_cube.numero());
...
int main(int argc,char **argv) {
	...
	//texture_cube = Texture(3,3,image_texture2);
