...
ImageGrisF image_test_2()
{
	...
	// avec la couleur 1.0 (blanc) et l'épaisseur 1
	dessiner_segment(I, 5,20 , 95,60 , 1.0 , 1);
...
int main(){
	...
	I_S.sauvegarder("exo4_seuillage_auto.png");
	...
	normaliser(TH);
	TH.afficher();
	TH.sauvegarder("exo4_transfomee_hough.png");
	...
	THC.afficher();
	THC.sauvegarder("exo4_maxima_transfomee_hough.png");
	...
	IC.afficher();
	IC.sauvegarder("exo4_maxima_image.png");
