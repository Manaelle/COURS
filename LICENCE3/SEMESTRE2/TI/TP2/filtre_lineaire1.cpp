...
//-------------------------------------------------------------------------
// AJOUTE : calculer l'image résultat de la convolution de 
...
int main(int argc, char *argv[])
{
	...
	ImageCouleurF I2("image-bruitee-3.png");
	I.afficher();
	
	// créer un filtre moyenne de taille n=1 (de dimension 3 x 3)
	FiltreLineaire K(2,  FiltreLineaire::Moyenne);
	
	// appliquer le filtre K à l'image I
	ImageCouleurF R;
	ImageCouleurF R1;
	R = convolution(I,K);
	R1=filtre_median(I2,3);
	R.afficher();
	R1.afficher();
	R.sauvegarder("bastille_convo.png");
	R1.sauvegarder("image-bruitee-3_median.png");
